...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_credit_transactions_user_key"),
        "credit_transactions",
        ["user_key"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_subscriptions_user_key"), "subscriptions", ["user_key"], unique=False
    )
    op.create_table(
        "user_credits",
        sa.Column("user_key", sa.String(length=80), nullable=False),
    ...
    op.create_index(
        op.f("ix_daily_stories_date"), "daily_stories", ["date"], unique=False
    )
    op.create_table(
        "reading_logs",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_reading_logs_user_key"), "reading_logs", ["user_key"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_credit_transactions_user_key"), table_name="credit_transactions"
    )
